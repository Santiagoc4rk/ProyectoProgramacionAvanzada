...
public class VistaRecepcionista extends JPanel {

    public VistaRecepcionista(VistaPrincipal base) {
        ...
        JLabel titulo = new JLabel("Panel Recepcionista");
        ...
        JButton btnCliente = crearBoton("Registrar Cliente", new Color(46, 134, 222));
        JButton btnPaquete = crearBoton("Registrar Paquete", new Color(39, 174, 96));

        btnCliente.addActionListener(e -> JOptionPane.showMessageDialog(this, "Próximamente: Registrar Cliente"));
        btnPaquete.addActionListener(e -> JOptionPane.showMessageDialog(this, "Próximamente: Registrar Paquete"));

        centro.add(btnCliente);
        centro.add(btnPaquete);
